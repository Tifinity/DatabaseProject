...
int Count::get_total_sales(int year, int month, MYSQL &mysql) {
    int total = 0;
...
int Count::get_total_number(int year, int month, MYSQL &mysql) {
    int total;
...
void Count::get_top_ten_books(int year, int month, MYSQL &mysql) {
